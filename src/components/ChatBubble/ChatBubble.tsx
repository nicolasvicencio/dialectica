  ...
  return (
    <div
      className={`
       ${
         isUser
           ? "bg-yellow-100 text-gray-500 self-end animate-fade animate-ease-linear rounded-tr-none "
           : "bg-white text-gray-500  animate-fade animate-ease-linear rounded-tl-none "
